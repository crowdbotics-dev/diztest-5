"""
Django settings for diztest_5 project.
...
WSGI_APPLICATION = 'diztest_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "diztest_5 API",
    "DESCRIPTION": "API documentation for diztest_5 App",
    "VERSION": "v1",
}
